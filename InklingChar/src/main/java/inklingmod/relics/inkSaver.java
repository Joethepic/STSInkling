...
public class inkSaver extends BaseRelic {
    private static final String NAME = "inkSaver"; //The name will be used for determining the image file as well as the ID.
    ...
    {
        return "Gives 1 #yinklingchar:Ink whenever using a card that needs #yinklingchar:Ink.";
    }
}