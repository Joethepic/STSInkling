...
import inklingmod.relics.inkTank;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.util.ArrayList;

import static basemod.animations.AbstractAnimation.Type.NONE;
import static inklingmod.inklingMod.*;
public class InklingCharacter extends CustomPlayer {
    private static final Logger log = LoggerFactory.getLogger(InklingCharacter.class);
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Inkling"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass INKLING;
        @SpireEnum(name = "CHARACTER_LORANGE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_LORANGE_COLOR") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(255, 201, 54, 1);
        ...
        public static void registerCharcter()
        {
            log.info("Adding Inkling");
            BaseMod.addCharacter(new InklingCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public InklingCharacter() {
        super(getNames()[0], Meta.INKLING,
                ...
                log.info("entered InklingCharacter");
        initializeClass(characterPath("dummy.png"),
                SHOULDER_2,
                SHOULDER_1,
                CORPSE,
                getLoadout(),
