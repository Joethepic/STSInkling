...
public class SplatBomb extends BaseCard {
    public static final String ID = makeID(SplatBomb.class.getSimpleName());
    ...
    {
        super(ID, info);
        setDamage(DAMAGE);//Pass the required information to the BaseCard constructor.
        setMagic(5, -2);
