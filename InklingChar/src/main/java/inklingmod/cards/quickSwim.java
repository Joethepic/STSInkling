...
public class quickSwim extends BaseCard {
    public static final String ID = makeID(quickSwim.class.getSimpleName());
    ...
    private static final int INK_GAINED = 2;
    private static final int UPG_INK_GAINED = 1;
    public quickSwim()
    {
        super(ID, info); //Pass the required information to the BaseCard constructor.
        setBlock(BLOCK, UPG_BLOCK); //Sets the card's block and how much it changes when upgraded.
        setMagic(INK_GAINED, UPG_INK_GAINED);
