...
import inklingmod.powers.aggressiveMovementPower;
import inklingmod.powers.evasiveMovementPower;
import inklingmod.util.CardStats;

public class aggressiveMovement extends BaseCard {
    public static final String ID = makeID(aggressiveMovement.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(p, p, new aggressiveMovementPower(p, magicNumber)));
    }
}
