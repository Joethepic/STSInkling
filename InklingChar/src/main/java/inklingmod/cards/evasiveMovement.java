...
public class evasiveMovement extends BaseCard {
    public static final String ID = makeID(evasiveMovement.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(p, p, new evasiveMovementPower(p, magicNumber)));
    }
}
