...
import inklingmod.powers.inkRecoveryPower;
import inklingmod.util.CardStats;

public class mainInkRecovery extends BaseCard {
    public static final String ID = makeID(mainInkRecovery.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(p, p, new inkRecoveryPower(p, p, 2)));
    }
}
